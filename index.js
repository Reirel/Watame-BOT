...
wiw = fs.readFileSync(`./src/gay.jpg`)
...
playys = args.join(" ")
anu = await fetchJson(`https://api-invibot.herokuapp.com/api/yt/playmp3?query=${playys}&apikey=APIKEY`)
infomp3 = `❒═════❬ *𝐏𝐋𝐀𝐘* ❭═════╾❒
├‣ *Nombre* : 
┴
${anu.title}
...
play2 = body.slice(6)
anu = await fetchJson(`https://api-invibot.herokuapp.com/api/yt/playmp4?query=${play2}&apikey=APIKEY`)
infomp3 = `❒═════❬ *𝐏𝐋𝐀𝐘2* ❭═════╾❒
├‣ *Nombre* : 
┴
${anu.title}
...
wnw = fs.readFileSync(`./src/lesbi.jpg`)						
